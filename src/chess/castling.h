...
constexpr i8 get_king_square(i8 color, bool castle_short)
{
...
constexpr i8 get_rook_square(i8 color, bool castle_short)
{
    assert(color::is_valid(color));
...
constexpr i8 get_rook_corner(i8 color, bool castle_short)
{
    assert(color::is_valid(color));
