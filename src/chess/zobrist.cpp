...
void init()
{
    for (i8 piece = 0; piece < 12; ++piece) {
        for (i8 square = 0; square < 64; ++square) {
            zobrist::PIECE[piece][square] = zobrist::get_rand64();
        }
    }

    for (i8 file = 0; file < 8; ++file) {
        zobrist::ENPASSANT[file] = zobrist::get_rand64();
    }

    zobrist::CASTLING[0] = 0;
    zobrist::CASTLING[castling::WHITE_SHORT] = zobrist::get_rand64();
    zobrist::CASTLING[castling::WHITE_LONG] = zobrist::get_rand64();
    zobrist::CASTLING[castling::BLACK_SHORT] = zobrist::get_rand64();
    zobrist::CASTLING[castling::BLACK_LONG] = zobrist::get_rand64();
