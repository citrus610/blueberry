...
constexpr Weight DEFAULT = Weight {
    .material_pawn = S(82, 144),
    .material_knight = S(426, 475),
    .material_bishop = S(441, 510),
    .material_rook = S(627, 803),
    .material_queen = S(1292, 1623),
    .material_king = S(10000, 10000),
    ...
    .mobility_knight = S(15, 25),
    .mobility_bishop = S(15, 25),
    .mobility_rook = S(-5, 25),
    .mobility_queen = S(-25, 25),
    .mobility_king = S(-25, 25),
};
